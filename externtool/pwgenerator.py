...
def ezremember_pw(min_word_length=3, max_word_length=8, max_int_value=1000, number_of_elements=4, no_special_characters=False):
    """
        Generate a password
    """
...
def hdremember_pw(min_length=15,max_length=25,no_special_characters=False):
    password = ''
...
def num_pw(min_length=15,max_length=25):
    password = ''
    for i in range(randint(min_length,max_length)):
        password += chr(randint(48, 57))
    return password

def char_pw(min_length=15,max_length=25,no_special_characters=False):
    password = ''
    for i in range(randint(min_length,max_length)):
        temp = randint(0,1)
        if temp == 0:
...
def main():
    ...
    parser.add_argument("-m", "--mode",type=int,
                        help='Select a mode to generate password',default=0)
    args = parser.parse_args()

    # Print a password
    print(ezremember_pw(min_word_length=args.min_word_length,
    ...
    print(hdremember_pw(min_length=15,max_length=25,no_special_characters=args.no_special_characters))
